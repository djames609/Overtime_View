...
Partial Class DisplayCrewInfoAuto
    ...
    Private Sub BindGridA()
        ...
        Dim Crew As String = "B17-Auto_3A"
            ...
            Using cmd As New SqlCommand("SELECT ID,  Name,Username, Classification, Bldg,Crew, PlantDate, Status, DateChanged FROM t_Employee_OT Where  Bldg ='" & SelectBldg & "' and crew = '" & Crew & "'")
                Using sda As New SqlDataAdapter()
                    ...
                    Using dt As New DataTable()
                        ...
                        GridView1.FooterRow.Cells(1).Text = "B17-Auto_3A Count"
    ...
    Private Sub BindGridB()
        Dim SelectBldg As String = "Building 17"
        Dim Crew As String = "B17-Auto_3B"
        Dim constr As String = ConfigurationManager.ConnectionStrings("CG_ITConnectionString").ConnectionString
        Using con As New SqlConnection(constr)
            ...
            Using cmd As New SqlCommand("SELECT ID,  Name,Username, Classification, Bldg,Crew, PlantDate,  Status, DateChanged FROM t_Employee_OT Where  Bldg ='" & SelectBldg & "' and  crew = '" & Crew & "'")
                Using sda As New SqlDataAdapter()
                    ...
                    Using dt As New DataTable()
                        ...
                        GridView2.FooterRow.Cells(1).Text = "B17-Auto_3B Crew"
    ...
    Private Sub BindGridC()
        Dim SelectBldg As String = "Building 17"
        Dim Crew As String = "B17-Auto_3C"
        Dim constr As String = ConfigurationManager.ConnectionStrings("CG_ITConnectionString").ConnectionString
        Using con As New SqlConnection(constr)
            ...
            Using cmd As New SqlCommand("SELECT ID,  Name,Username, Classification, Bldg,Crew, PlantDate,  Status, DateChanged FROM t_Employee_OT Where  Bldg ='" & SelectBldg & "' and crew = '" & Crew & "'")
                Using sda As New SqlDataAdapter()
                    ...
                    Using dt As New DataTable()
                        ...
                        GridView3.FooterRow.Cells(1).Text = "B17-Auto_3C Crew"
            ...
            Using cmd As New SqlCommand("SELECT ID,  Name,Username, Classification, Bldg,Crew, PlantDate,  Status, DateChanged FROM t_Employee_OT Where  Bldg ='" & SelectBldg & "' and crew = '" & Crew & "'")
                Using sda As New SqlDataAdapter()
                    ...
                    Using dt As New DataTable()
                        ...
                        GridView4.FooterRow.Cells(1).Text = "B17-Auto_D Crew"
    ...
    Private Sub BindGridE()
        Dim SelectBldg As String = "Building 17"
        Dim Crew As String = "B17-Auto_LOFL_A"
        Dim constr As String = ConfigurationManager.ConnectionStrings("CG_ITConnectionString").ConnectionString
        Using con As New SqlConnection(constr)
            ...
            Using cmd As New SqlCommand("SELECT ID,  Name,Username, Classification, Bldg,Crew, PlantDate,  Status, DateChanged FROM t_Employee_OT Where  Bldg ='" & SelectBldg & "' and crew = '" & Crew & "'")
                Using sda As New SqlDataAdapter()
                    ...
                    Using dt As New DataTable()
                        ...
                        GridView5.FooterRow.Cells(1).Text = "B17-Auto_LOFL_A Count"
