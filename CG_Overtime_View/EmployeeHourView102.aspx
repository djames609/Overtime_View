<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EmployeeHourView102.aspx.vb" Inherits="EmployeeHourView102" %>
...
<body>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ConnectionString="<%$ ConnectionStrings:CG_ITConnectionString %>" 
         ...
         SelectCommand="SELECT  tmw.Person_ID, Max(tmw.Emp_Name) as Emp_Name FROM t_manual_worked_52 tmw inner join t_employee_OT teo on tmw.Person_ID = teo. Username where teo.Bldg = 'Building 102' group by tmw.Person_ID Order by Emp_Name"></asp:SqlDataSource>
    <hr />
