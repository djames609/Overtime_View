<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EmployeeHourView17.aspx.vb" Inherits="EmployeeHourView17" %>
...
<body>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT DISTINCT tmw.Person_ID, tmw.Emp_Name FROM t_manual_worked_52 tmw inner join t_employee_OT teo on tmw.Person_ID = teo. Username where teo.Bldg = 'Building 17'  Order by Emp_Name"></asp:SqlDataSource>
    <hr />
